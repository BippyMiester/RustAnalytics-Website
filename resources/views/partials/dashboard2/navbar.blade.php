...
<div id="header" class="app-header">
    ...
    <div class="brand">
        <a href="{{ route('index') }}" class="brand-logo">
            ...
            <span class="brand-text">Rust Analytics</span>
        </a>
    </div>
    <!-- END brand -->
        ...
        <div class="menu-item dropdown dropdown-mobile-full">
            <a href="{{ route('user.profile.index') }}" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
                <div class="menu-img online">
                    ...
                    <img src="{{ $user->avatar }}" alt="Profile" height="60">
                </div>
                <div class="menu-text d-sm-block d-none w-170px">{{ $user->username }}</div>
            </a>
            <div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
                <a class="dropdown-item d-flex align-items-center" href="{{ route('user.profile.index') }}">PROFILE <i class="bi bi-person-circle ms-auto text-theme fs-16px my-n1"></i></a>
                <a class="dropdown-item d-flex align-items-center" href="{{ route('user.profile.settings') }}">SETTINGS <i class="bi bi-gear ms-auto text-theme fs-16px my-n1"></i></a>
