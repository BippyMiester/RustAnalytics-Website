...
<div id="preloader">
    <div class="preloader-wrap">
        <img src="imgs/app/placeholders/favicon.png" alt="logo" class="img-fluid preloader-icon" />
...
<div class="main-wrapper">
        ...
        <nav class="navbar navbar-expand-xl navbar-dark sticky-header">
            <div class="container d-flex align-items-center justify-content-lg-between position-relative">
                <a href="index.html" class="navbar-brand d-flex align-items-center mb-md-0 text-decoration-none">
                    <img src="imgs/app/placeholders/logo-white.png" alt="logo" class="img-fluid logo-white" />
                    <img src="imgs/app/placeholders/logo-color.png" alt="logo" class="img-fluid logo-color" />
                </a>
                            ...
                            <div class="dropdown-menu border-0 rounded-custom shadow py-0 bg-white">
                                <div class="dropdown-grid rounded-custom width-full-3">
                                    ...
                                    <div class="dropdown-grid-item last-item bg-light radius-right-side">
                                        <a href="#"><img src="imgs/app/placeholders/feature-img3.jpg" alt="add" class="img-fluid rounded-custom" /></a>
                                    </div>
                                </div>
                            </div>
                        </li>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasWithBackdrop">
                    <div class="offcanvas-header d-flex align-items-center mt-4">
                        <a href="index.html" class="d-flex align-items-center mb-md-0 text-decoration-none">
                            <img src="imgs/app/placeholders/logo-color.png" alt="logo" class="img-fluid ps-2" />
                        </a>
    ...
    <!--hero section start-->
    <section class="hero-section ptb-120 text-white bg-dark" style="background: url('imgs/app/placeholders/hero-dot-bg.png')no-repeat center right">
        <div class="container">
            <div class="row justify-content-center text-center text-lg-start align-items-center">
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="hero-img-wrap position-relative app-screen-bg mt-5" style="background-image: url('imgs/app/placeholders/shape/shape-bg-3.svg')" data-aos="fade-up" data-aos-delay="200">
                        <!--animated shape start-->
                        <ul class="position-absolute animate-element parallax-element shape-service d-none d-lg-block">
                            <li class="layer" data-depth="0.03">
                                <img src="imgs/app/placeholders/color-shape/image-4.svg" alt="shape" class="img-fluid position-absolute color-shape-1">
                            </li>
                            <li class="layer" data-depth="0.02">
                                <img src="imgs/app/placeholders/color-shape/feature-2.svg" alt="shape" class="img-fluid position-absolute color-shape-2 z-5">
                            </li>
                            <li class="layer" data-depth="0.03">
                                <img src="imgs/app/placeholders/color-shape/feature-3.svg" alt="shape" class="img-fluid position-absolute color-shape-3">
                            </li>
                        </ul>
                        <!--animated shape end-->
                ...
                <div class="col-lg-6 order-lg-1">
                    <div class="pr-lg-4 position-relative" data-aos="fade-up">
                        ...
                        <ul class="position-absolute animate-element parallax-element shape-service z--1 hide-medium">
                            <li class="layer" data-depth="0.03">
                                <img src="imgs/app/placeholders/color-shape/image-2.svg" alt="shape" class="img-fluid position-absolute color-shape-1">
                            </li>
                            <li class="layer" data-depth="0.02">
                                <img src="imgs/app/placeholders/color-shape/feature-2.svg" alt="shape" class="img-fluid position-absolute color-shape-2 z-5">
                            </li>
                        ...
                        <div class="bg-light text-center rounded-custom overflow-hidden pt-5 px-3 px-lg-5 mx-lg-auto">
                            ...
                            <div class="position-relative w-75 mx-auto">
                                <img class="position-relative z-2 w-100 h-auto" src="imgs/app/placeholders/screen/half-iphone.svg" alt="Image Description">
                                <img class="position-absolute half-screen" src="imgs/app/placeholders/screen/app-screen-1.jpg" alt="Image Description">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-lg-center justify-content-between">
                ...
                <div class="col-lg-6">
                    <div class="pr-lg-4 position-relative" data-aos="fade-up">
                        ...
                        <ul class="position-absolute animate-element parallax-element shape-service z--1 hide-medium">
                            <li class="layer" data-depth="0.03">
                                <img src="imgs/app/placeholders/color-shape/image-3.svg" alt="shape" class="img-fluid position-absolute color-shape-1">
                            </li>
                            <li class="layer" data-depth="0.02">
                                <img src="imgs/app/placeholders/color-shape/feature-1.svg" alt="shape" class="img-fluid position-absolute color-shape-2 z-5">
                            </li>
                            <li class="layer" data-depth="0.03">
                                <img src="imgs/app/placeholders/color-shape/feature-3.svg" alt="shape" class="img-fluid position-absolute color-shape-3">
                            </li>
                        ...
                        <div class="bg-light text-center shadow-sm rounded-custom overflow-hidden pt-5 px-3 px-lg-5 mx-lg-auto">
                            ...
                            <div class="position-relative w-75 mx-auto">
                                <img class="position-relative z-2 w-100 h-auto" src="imgs/app/placeholders/screen/half-iphone.svg" alt="Image Description">
                                <img class="position-absolute half-screen" src="imgs/app/placeholders/screen/app-screen-2.jpg" alt="Image Description">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-container testimonialSwiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide border border-2 p-5 rounded-custom position-relative">
                                    <img src="imgs/app/placeholders/testimonial/quotes-dot.svg" alt="quotes" width="100" class="img-fluid position-absolute left-0 top-0 z--1 p-3">
                                    <div class="d-flex mb-32 align-items-center">
                                        <img src="imgs/app/placeholders/testimonial/1.jpg" class="img-fluid me-3 rounded" width="60" alt="user">
                                    ...
                                    <img src="imgs/app/placeholders/testimonial/quotes.svg" alt="quotes" class="position-absolute right-0 bottom-0 z--1 pe-4 pb-4">
                                </div>
                                <div class="swiper-slide border border-2 p-5 rounded-custom position-relative">
                                    <img src="imgs/app/placeholders/testimonial/quotes-dot.svg" alt="quotes" width="100" class="img-fluid position-absolute left-0 top-0 z--1 p-3">
                                    <div class="d-flex mb-32 align-items-center">
                                        <img src="imgs/app/placeholders/testimonial/3.jpg" class="img-fluid me-3 rounded" width="60" alt="user">
                                        <div class="author-info">
                                ...
                                <div class="swiper-slide border border-2 p-5 rounded-custom position-relative">
                                    <img src="imgs/app/placeholders/testimonial/quotes-dot.svg" alt="quotes" width="100" class="img-fluid position-absolute left-0 top-0 z--1 p-3">
                                    <div class="d-flex mb-32 align-items-center">
                                        <img src="imgs/app/placeholders/testimonial/2.jpg" class="img-fluid me-3 rounded" width="60" alt="user">
                                        <div class="author-info">
                                            <h6 class="mb-0">Mr.Rupan Oberoi</h6>
                                ...
                                <div class="swiper-slide border border-2 p-5 rounded-custom position-relative">
                                    <img src="imgs/app/placeholders/testimonial/quotes-dot.svg" alt="quotes" width="100" class="img-fluid position-absolute left-0 top-0 z--1 p-3">
                                    <div class="d-flex mb-32 align-items-center">
                                        <img src="imgs/app/placeholders/testimonial/4.jpg" class="img-fluid me-3 rounded" width="60" alt="user">
                                        <div class="author-info">
                                ...
                                <div class="swiper-slide border border-2 p-5 rounded-custom position-relative">
                                    <img src="imgs/app/placeholders/testimonial/quotes-dot.svg" alt="quotes" width="100" class="img-fluid position-absolute left-0 top-0 z--1 p-3">
                                    <div class="d-flex mb-32 align-items-center">
                                        <img src="imgs/app/placeholders/testimonial/5.jpg" class="img-fluid me-3 rounded" width="60" alt="user">
                                        <div class="author-info">
    ...
    <section class="contact-us ptb-120 position-relative overflow-hidden">
        ...
        <div class=" bg-dark position-absolute bottom-0 h-25 bottom-0 left-0 right-0 z--1 py-5" style="background: url('imgs/app/placeholders/shape/dot-dot-wave-shape.svg')no-repeat center top">
...
<!--build:js-->
<script src="{{ asset('js/app/vendors/jquery-3.6.0.min.js') }}"></script>
<script src="{{ asset('js/app/vendors/bootstrap.bundle.min.js') }}"></script>
<script src="{{ asset('js/app/vendors/swiper-bundle.min.js') }}"></script>
<script src="{{ asset('js/app/vendors/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ asset('js/app/vendors/parallax.min.js') }}"></script>
<script src="{{ asset('js/app/vendors/aos.js') }}"></script>
