    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="text-center">
                <!-- Pagination Links -->
                {{ $destroyedBuildings->appends(['destroyedBuildingsPage' => $destroyedBuildings->currentPage(), 'killsPage' => Request::get('killsPage'), 'deathsPage' => Request::input('deathsPage'), 'weaponFirePage' => Request::input('weaponFirePage'), 'gatherPage' => Request::input('gatherPage')])->links('pagination::bootstrap-4') }}
            </div>
        </div>
