                        ...
                        <table class="w-100 mb-0 small align-middle text-nowrap">
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="position-relative mb-2">
                                            <div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px" style="background-image: url(imgs/dashboard2/dashboard/product-1.jpeg);">
                                            </div>
                                ...
                                <td>
                                    <div class="d-flex mb-2 align-items-center">
                                        <div class="position-relative">
                                            <div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px" style="background-image: url(imgs/dashboard2/dashboard/product-2.jpeg);">
                                            </div>
                                            <div class="position-absolute top-0 start-0">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex mb-2 align-items-center">
                                        <div class="position-relative">
                                            <div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px" style="background-image: url(imgs/dashboard2/dashboard/product-3.jpeg);">
                                            </div>
                                            <div class="position-absolute top-0 start-0">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex mb-2 align-items-center">
                                        <div class="position-relative">
                                            <div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px" style="background-image: url(imgs/dashboard2/dashboard/product-4.jpeg);">
                                            </div>
                                            <div class="position-absolute top-0 start-0">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="position-relative">
                                            <div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px" style="background-image: url(imgs/dashboard2/dashboard/product-5.jpeg);">
                                            </div>
                                            <div class="position-absolute top-0 start-0">
