window.addEventListener("load", function(){
    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: true,
                logo: {
                    darkLogo: '../../imgs/placeholders/logo.svg',
                    lightLogo: '../../imgs/placeholders/logo2.svg'
                }
            }
        },
        reset: false
    ...
    if (corkThemeObject.settings.layout.darkMode) {
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            //         document.querySelector('.navbar-logo').setAttribute('src', '../../imgs/placeholders/logo.svg')
            //     }
            // } else {
            //     if (document.querySelector('.navbar-logo')) {
